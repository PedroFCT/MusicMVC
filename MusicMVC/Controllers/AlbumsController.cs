...
namespace MusicMVC.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public AlbumsController(MusicMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AlbumID,AlbumName,DateReleased,ArtistID,GenreID")] Albums albums)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AlbumID,AlbumName,DateReleased,ArtistID,GenreID")] Albums albums)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            if (_context.Albums == null)
            {
                return Problem("Entity set 'MusicMVCContext.Albums'  is null.");
            }
            var albums = await _context.Albums.FindAsync(id);
            if (albums != null)
            {
